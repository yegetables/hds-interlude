...
当前版本：`0.1.4-tg.3`。提供宿主时间轴、持续生活剧本、结构化投递、Schedule Preplan、群聊意愿、多提供商模型连接与可选聊天动作。本 fork 新增可选 TTS 语音（mitts / 小米 MiMo）与 Telegram 适配。
...
10. **可选能力**：视觉、Puppeteer、网页观察、TTS 语音（本 fork，mitts / 小米 MiMo）、日志级别和日志内容开关。
